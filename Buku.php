...
class Buku extends CI_Controller {
	...
	public function submit(){
		if($this->input->post('submit')){
			...
			$this->form_validation->set_rules('pengarang', 'Penulis', 'trim|required');
			$this->form_validation->set_rules('penerbit', 'Penerbit', 'trim|required');
			$this->form_validation->set_rules('tahun_terbit', 'Tahun', 'trim|required|numeric');
			$this->form_validation->set_rules('stok', 'Jumlah', 'trim|required|numeric');
