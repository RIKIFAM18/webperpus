                    ...
                    <table id="datatable" class="table table-striped table-bordered">
                        ...
                        <?php foreach ($list as $bookList):?>
                            <tr>
                                ...
                                <td><?php echo $bookList->judul_buku ?></td>
                                <td><?php echo $bookList->id_kategori ?></td>
                                <td><?php echo $bookList->pengarang ?></td>
                                <td><?php echo $bookList->penerbit ?></td>
                                <td><?php echo $bookList->tahun_terbit ?></td>
                                <td><?php echo $bookList->stok ?></td>
                                <td><?php echo $bookList->dipinjam ?></td>
                                <?php if($this->session->userdata('role')=='superadmin'): ?>
                                <td>
